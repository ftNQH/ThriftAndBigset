...
func (p *TStringBigSetKVServiceClient) BsMultiPutBsItem(ctx context.Context, listBsItems []*TBigsetItem) (r *TMultiPutBigsetItemResult_, err error) {
	var _args109 TStringBigSetKVServiceBsMultiPutBsItemArgs
	_args109.ListBsItems = listBsItems
	var _result110 TStringBigSetKVServiceBsMultiPutBsItemResult
	if err = p.Client_().Call(ctx, "bsMultiPutBsItem", &_args109, &_result110); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) BsMultiRemoveBsItem(ctx context.Context, listBsItems []*TBigsetItem) (r *TMultiRemoveBigsetItemResult_, err error) {
	var _args111 TStringBigSetKVServiceBsMultiRemoveBsItemArgs
	_args111.ListBsItems = listBsItems
	var _result112 TStringBigSetKVServiceBsMultiRemoveBsItemResult
	if err = p.Client_().Call(ctx, "bsMultiRemoveBsItem", &_args111, &_result112); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) CreateStringBigSet(ctx context.Context, bsName TStringKey) (r *TBigSetInfoResult_, err error) {
	var _args113 TStringBigSetKVServiceCreateStringBigSetArgs
	_args113.BsName = bsName
	var _result114 TStringBigSetKVServiceCreateStringBigSetResult
	if err = p.Client_().Call(ctx, "createStringBigSet", &_args113, &_result114); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) GetBigSetInfoByName(ctx context.Context, bsName TStringKey) (r *TBigSetInfoResult_, err error) {
	var _args115 TStringBigSetKVServiceGetBigSetInfoByNameArgs
	_args115.BsName = bsName
	var _result116 TStringBigSetKVServiceGetBigSetInfoByNameResult
	if err = p.Client_().Call(ctx, "getBigSetInfoByName", &_args115, &_result116); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) AssignBigSetName(ctx context.Context, bsName TStringKey, bigsetID TContainerKey) (r *TBigSetInfoResult_, err error) {
	var _args117 TStringBigSetKVServiceAssignBigSetNameArgs
	_args117.BsName = bsName
	_args117.BigsetID = bigsetID
	var _result118 TStringBigSetKVServiceAssignBigSetNameResult
	if err = p.Client_().Call(ctx, "assignBigSetName", &_args117, &_result118); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) BsPutItem(ctx context.Context, bsName TStringKey, item *TItem) (r *TPutItemResult_, err error) {
	var _args119 TStringBigSetKVServiceBsPutItemArgs
	_args119.BsName = bsName
	_args119.Item = item
	var _result120 TStringBigSetKVServiceBsPutItemResult
	if err = p.Client_().Call(ctx, "bsPutItem", &_args119, &_result120); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) BsRemoveItem(ctx context.Context, bsName TStringKey, itemKey TItemKey) (r bool, err error) {
	var _args121 TStringBigSetKVServiceBsRemoveItemArgs
	_args121.BsName = bsName
	_args121.ItemKey = itemKey
	var _result122 TStringBigSetKVServiceBsRemoveItemResult
	if err = p.Client_().Call(ctx, "bsRemoveItem", &_args121, &_result122); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) BsExisted(ctx context.Context, bsName TStringKey, itemKey TItemKey) (r *TExistedResult_, err error) {
	var _args123 TStringBigSetKVServiceBsExistedArgs
	_args123.BsName = bsName
	_args123.ItemKey = itemKey
	var _result124 TStringBigSetKVServiceBsExistedResult
	if err = p.Client_().Call(ctx, "bsExisted", &_args123, &_result124); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) BsGetItem(ctx context.Context, bsName TStringKey, itemKey TItemKey) (r *TItemResult_, err error) {
	var _args125 TStringBigSetKVServiceBsGetItemArgs
	_args125.BsName = bsName
	_args125.ItemKey = itemKey
	var _result126 TStringBigSetKVServiceBsGetItemResult
	if err = p.Client_().Call(ctx, "bsGetItem", &_args125, &_result126); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) BsGetSlice(ctx context.Context, bsName TStringKey, fromPos int32, count int32) (r *TItemSetResult_, err error) {
	var _args127 TStringBigSetKVServiceBsGetSliceArgs
	_args127.BsName = bsName
	_args127.FromPos = fromPos
	_args127.Count = count
	var _result128 TStringBigSetKVServiceBsGetSliceResult
	if err = p.Client_().Call(ctx, "bsGetSlice", &_args127, &_result128); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) BsGetSliceFromItem(ctx context.Context, bsName TStringKey, fromKey TItemKey, count int32) (r *TItemSetResult_, err error) {
	var _args129 TStringBigSetKVServiceBsGetSliceFromItemArgs
	_args129.BsName = bsName
	_args129.FromKey = fromKey
	_args129.Count = count
	var _result130 TStringBigSetKVServiceBsGetSliceFromItemResult
	if err = p.Client_().Call(ctx, "bsGetSliceFromItem", &_args129, &_result130); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) BsGetSliceR(ctx context.Context, bsName TStringKey, fromPos int32, count int32) (r *TItemSetResult_, err error) {
	var _args131 TStringBigSetKVServiceBsGetSliceRArgs
	_args131.BsName = bsName
	_args131.FromPos = fromPos
	_args131.Count = count
	var _result132 TStringBigSetKVServiceBsGetSliceRResult
	if err = p.Client_().Call(ctx, "bsGetSliceR", &_args131, &_result132); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) BsGetSliceFromItemR(ctx context.Context, bsName TStringKey, fromKey TItemKey, count int32) (r *TItemSetResult_, err error) {
	var _args133 TStringBigSetKVServiceBsGetSliceFromItemRArgs
	_args133.BsName = bsName
	_args133.FromKey = fromKey
	_args133.Count = count
	var _result134 TStringBigSetKVServiceBsGetSliceFromItemRResult
	if err = p.Client_().Call(ctx, "bsGetSliceFromItemR", &_args133, &_result134); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) BsRangeQuery(ctx context.Context, bsName TStringKey, startKey TItemKey, endKey TItemKey) (r *TItemSetResult_, err error) {
	var _args135 TStringBigSetKVServiceBsRangeQueryArgs
	_args135.BsName = bsName
	_args135.StartKey = startKey
	_args135.EndKey = endKey
	var _result136 TStringBigSetKVServiceBsRangeQueryResult
	if err = p.Client_().Call(ctx, "bsRangeQuery", &_args135, &_result136); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) BsBulkLoad(ctx context.Context, bsName TStringKey, setData *TItemSet) (r bool, err error) {
	var _args137 TStringBigSetKVServiceBsBulkLoadArgs
	_args137.BsName = bsName
	_args137.SetData = setData
	var _result138 TStringBigSetKVServiceBsBulkLoadResult
	if err = p.Client_().Call(ctx, "bsBulkLoad", &_args137, &_result138); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) BsMultiPut(ctx context.Context, bsName TStringKey, setData *TItemSet, getAddedItems bool, getReplacedItems bool) (r *TMultiPutItemResult_, err error) {
	var _args139 TStringBigSetKVServiceBsMultiPutArgs
	_args139.BsName = bsName
	_args139.SetData = setData
	_args139.GetAddedItems = getAddedItems
	_args139.GetReplacedItems = getReplacedItems
	var _result140 TStringBigSetKVServiceBsMultiPutResult
	if err = p.Client_().Call(ctx, "bsMultiPut", &_args139, &_result140); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) GetTotalCount(ctx context.Context, bsName TStringKey) (r int64, err error) {
	var _args141 TStringBigSetKVServiceGetTotalCountArgs
	_args141.BsName = bsName
	var _result142 TStringBigSetKVServiceGetTotalCountResult
	if err = p.Client_().Call(ctx, "getTotalCount", &_args141, &_result142); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) RemoveAll(ctx context.Context, bsName TStringKey) (r int64, err error) {
	var _args143 TStringBigSetKVServiceRemoveAllArgs
	_args143.BsName = bsName
	var _result144 TStringBigSetKVServiceRemoveAllResult
	if err = p.Client_().Call(ctx, "removeAll", &_args143, &_result144); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) TotalStringKeyCount(ctx context.Context) (r int64, err error) {
	var _args145 TStringBigSetKVServiceTotalStringKeyCountArgs
	var _result146 TStringBigSetKVServiceTotalStringKeyCountResult
	if err = p.Client_().Call(ctx, "totalStringKeyCount", &_args145, &_result146); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) GetListKey(ctx context.Context, fromIndex int64, count int32) (r []TStringKey, err error) {
	var _args147 TStringBigSetKVServiceGetListKeyArgs
	_args147.FromIndex = fromIndex
	_args147.Count = count
	var _result148 TStringBigSetKVServiceGetListKeyResult
	if err = p.Client_().Call(ctx, "getListKey", &_args147, &_result148); err != nil {
		return
	}
...
func (p *TStringBigSetKVServiceClient) GetListKeyFrom(ctx context.Context, keyFrom TStringKey, count int32) (r []TStringKey, err error) {
	var _args149 TStringBigSetKVServiceGetListKeyFromArgs
	_args149.KeyFrom = keyFrom
	_args149.Count = count
	var _result150 TStringBigSetKVServiceGetListKeyFromResult
	if err = p.Client_().Call(ctx, "getListKeyFrom", &_args149, &_result150); err != nil {
		return
	}
